...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Briem Engineering">
    <meta name="author" content="Michaela Kuba">
    ...
    <!-- Fonts -->
    <link href="/css/droidsans_bold_macroman/stylesheet.css" rel="stylesheet">
  ...
  <body>
    ...
    <div class="row featurette">
      <div class="col-md-7 order-md-2">
        <h2 class="featurette-heading blurb-header1" style="margin-top:1rem">Contact Briem. 
        <h3 class="text-muted blurb-header2">Access to Briem Engineering's Experts</span></h2>
        <p class="lead">The Briem Engineering team can be quickly accessed through the phone or email.</p>
      </div>
      <div class="col-md-5 order-md-1">
        <img class="featurette-image img-fluid mx-auto" src="images/about_contact_clients.jpg" alt="Briem Facility">
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-md-3">
        <h3 class="blurb-header2">Contact Us</h2>
        <p>Briem Engineering serves customers from its base in the St. Louis area. Our location and mailing address is:</p>
        <p>Briem Engineering<br>
        4134 Rider Trail North<br>
        St. Louis, MO 63045</p>
